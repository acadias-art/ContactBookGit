...
public class Main {
    ...
    public static final String EQUALS_EXIST = "There are contacts that share phone numbers.";
    public static final String NO_EQUALS = "All contacts have different phone numbers.";
    ...
    private static void hasEquals (ContactBook cBook){
        if (cBook.hasEquals()){
            System.out.println(EQUALS_EXIST);
        }else System.out.println(NO_EQUALS);
    }
}
